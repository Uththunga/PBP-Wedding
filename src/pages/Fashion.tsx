...
const Fashion = () => {
  const fashionImages = images.filter(img => img.category === 'fashion');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[60vh] bg-cover bg-center" style={{
        backgroundImage: `url('https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&q=80')`
      }}>
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center">
          <div className="max-w-3xl px-4">
            ...
            <p className="text-xl text-white mb-8">
              Editorial and high-fashion photography that makes a statement
            </p>
          </div>
        </div>
      </div>
