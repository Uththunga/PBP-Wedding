...
const Portraits = () => {
  const portraitImages = images.filter(img => img.category === 'portraits');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[60vh] bg-cover bg-center" style={{
        backgroundImage: `url('https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&q=80')`
      }}>
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center">
          <div className="max-w-3xl px-4">
            ...
            <p className="text-xl text-white mb-8">
              Capturing personalities and stories through portraits
            </p>
          </div>
        </div>
      </div>
